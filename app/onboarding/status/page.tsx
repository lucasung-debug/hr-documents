          ...
          {allCompleted ? (
            <>
              <div className="flex flex-col items-center gap-3">
                ...
                <h2 className="text-xl font-bold text-gray-900">서류 작성이 완료되었습니다.</h2>
            ...
            <>
              <div className="flex flex-col items-center gap-3">
                ...
                <h2 className="text-xl font-bold text-gray-900">미완료 서류가 있습니다.</h2>
                <div className="text-left w-full bg-yellow-50 rounded-xl border border-yellow-200 p-4">
